    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-heading bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-6 leading-tight animate-fadeIn">
          Math Tutor Agent
        </h1>
          ...
          <Card className="mb-8 bg-gray-800/50 backdrop-blur-xl border-gray-700/50 shadow-2xl">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                className="w-full py-6 text-lg font-semibold bg-gradient-to-r from-primary to-secondary hover:from-primary-dark hover:to-secondary-dark text-white shadow-glow transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
        ...
        <AnimatePresence>
          {solution && (
            ...
            >
              ...
              <Card className="bg-card backdrop-blur-xl border border-border shadow-card animate-fadeIn">
                ...
                <CardHeader className="pb-4">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <CardTitle className="text-2xl text-white flex items-center">
                        ...
                        <div className="w-8 h-8 bg-gradient-to-r from-primary to-secondary rounded-lg flex items-center justify-center mr-3 shadow-glow">
        ...
        {/* Footer */}
        <motion.footer
          className="mt-16 text-center text-muted-foreground text-sm border-t border-border pt-6"
